...
const users = [
  { id: 'user_1', name: 'John Patient', email: 'patient@test.com', password: '123456', role: 'patient' },
  { id: 'user_2', name: 'Dr. Sarah Smith', email: 'doctor@test.com', password: '123456', role: 'doctor' },
  { id: 'admin_1', name: 'WeCureIT Admin', email: 'wecureIT@gwuproject.com', password: 'wecureIT', role: 'admin' },
]
